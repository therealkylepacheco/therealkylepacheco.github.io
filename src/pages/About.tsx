        ...
        <>
            <PageTitle text="About" />
                <ResponsiveContent sectionTitle="Experience">
                    <Content title="Software Developer, Liiingo (2021-Present)" body="I currently work as a software developer at Liiingo. The majority of my work is on the front end of a web app in ReactJS. I build custom components based on feature requests, implement UX designs, and interact with a Redux state store." img={liiingoLogo} alt="Liiingo"/>                
                    <Content title="Software Engineer, In Time Tec (2020-2021)" body="At In Time Tec, I worked contracted out to Kount where I was a software developer on the CPE team. I worked improving the current product through bug fixes, adding features, and improving the user experience." img={ittLogo} alt="In Time Tec"/>                
                    <Content title="Software Development Engineer in Test Intern, Kount (Summer 2019)" body="This was a summer internship with the Boise, ID based company Kount. My summer project was to design a command line interface for internal use. Upon completion, I worked on cross-project triggering and status attribution in GitLab." img={kountLogo} alt="Kount"/>                
                </ResponsiveContent>
                <ResponsiveContent sectionTitle="Education">
                    <Content title="Northwest Nazarene University, BS Computer Science" body="I attended NNU and earned my BS in Computer Science over the course of 2.5 years. During my time here, I served as the Computer Club Treasurer and IEEE Chapter secretary. I graduated in December 2019 Magna Cum Laude." img={nnuLogo} alt="NNU" imgPosition="left" />
                    <Content title="Idaho State University, AA General Studies" body="I earned my associate's degree concurrently in high school. This allowed me to complete my gen ed requirements rapidly and graduate ahead of schedule." img={isuLogo} alt="ISU" imgPosition="left" />
                </ResponsiveContent>
